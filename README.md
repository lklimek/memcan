...
The `memcan extract` CLI binary remains available for use by the `lessons-learned` skill (now in the [claudius](https://github.com/lklimek/claudius) plugin), which provides deliberate, quality-controlled extraction with human oversight.
